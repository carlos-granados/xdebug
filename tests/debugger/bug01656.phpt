...
?>
--EXPECTF--
%A[Step Debug] WARN: Could not connect to debugging client. Tried: 127.0.0.1:9999 (from I_LIKE_COOKIES HTTP header), localhost:9999 (fallback through xdebug.client_host/xdebug.client_port).
